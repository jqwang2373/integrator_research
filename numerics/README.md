...
| `v049_paper_experiments/` | Experiments E1–E7 behind the rewritten manuscript (2026-09-21): chain convergence, Gauss family, friction sweep, four public mechanisms, public-code comparison, regular-branch drift, solver envelope; `make_figures.py` draws the paper's figures from `results/`. |
