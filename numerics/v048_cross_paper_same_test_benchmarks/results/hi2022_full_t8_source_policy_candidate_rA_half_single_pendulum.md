...
- Form/model: `rA_half` / `single_pendulum`.
...
- Position pair orders: `[-0.01122725542325414, -0.28339349346837284]`.
- Velocity pair orders: `[1.0007568147469175, 1.000359627081342]`.
- Acceleration pair orders: `[0.9517541301647995, 0.9767914062085483]`.
- Runtime values: `[0.343863989925012, 0.5749531000619754, 1.066894399933517]`.
- Reference runtime: `8.460787251009606`.
