...
PAPER_MATRIX = ROOT.parent / "validation" / "paper_v047_cylindrical_chain" / "PAPER_NUMERICAL_RESULT_MATRIX.csv"
CLAIM_BOUNDARY = ROOT.parent / "validation" / "paper_v047_cylindrical_chain" / "CLAIM_BOUNDARY.json"
...
def run_checks() -> list[dict[str, object]]:
    commands = [
        (
            ...
            ROOT.parent / "validation" / "paper_v047_cylindrical_chain",
