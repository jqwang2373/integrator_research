...
V048_WORKDIR = PAPER.parent.parent / "numerics" / "v048_cross_paper_same_test_benchmarks"
...
def command_preflight(command_text: str | None) -> dict[str, Any]:
    ...
    return {
        ...
        "execution_working_directory": "../../numerics/v048_cross_paper_same_test_benchmarks",
