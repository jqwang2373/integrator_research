...
`CMAME_SUBMISSION_CHECKLIST.md` included in the submission package. The superseded
internal drafts `main_concise.pdf` and `main.pdf` are kept in `validation/legacy_drafts/`
for audit continuity and are not part of the submission.
