...
ROOT = PAPER.parent
V047 = ROOT.parent / "numerics" / "v047_cylindrical_chain_pipeline" / "run_v047.py"
V043 = ROOT.parent / "numerics" / "v043_skew_prismatic_lower_pair" / "run_v043.py"
SUMMARY = ROOT.parent / "numerics" / "v047_cylindrical_chain_pipeline" / "results" / "summary_v047.json"
...
def main() -> None:
    ...
    result = {
        ...
        "source_files": {
            "v047_residual_source": "../../numerics/v047_cylindrical_chain_pipeline/run_v047.py",
            "v043_brown_mcphee_source": "../../numerics/v043_skew_prismatic_lower_pair/run_v043.py",
            "v047_summary": "../../numerics/v047_cylindrical_chain_pipeline/results/summary_v047.json",
        },
    }
