...
ARS route: `academic-paper-reviewer/full`.
Reference text read: `True` from `../../external/literature/s11044-026-10153-w.txt`.
Manuscript text read: `True` from `main_cmame.txt`.
Flat manuscript text read: `True` from `cmame_submission_flat/main_cmame_submission.txt`.

## PDF Inventories

| document | lines | words | headings | figures | tables | algorithms | theorems | proof tokens | work-precision mentions | audit residue |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| reference_style_pdf | 1587 | 11863 | 179 | 18 | 3 | 2 | 0 | 0 | 4 | 0 |
| current_main_cmame_pdf | 3495 | 26610 | 239 | 13 | 20 | 1 | 1 | 19 | 2 | 117 |
| current_flat_submission_pdf | 3495 | 26610 | 239 | 13 | 20 | 1 | 1 | 19 | 2 | 117 |
...
- Data availability and declarations present: `True`.
- Appendix coefficient formulas present: `True`.

## Manuscript Style Features

- All-method matrix visible in PDF: `True`.
- Theorem/proof tokens present: `True/True`.
- Figure set present: `True`.
- Data availability and declarations present: `True`.
