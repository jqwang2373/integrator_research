...
def main() -> None:
    ...
    result = {
        ...
        "source_files": {
            "common_reference_json": work_label(COMMON_JSON),
            "common_reference_csv": work_label(COMMON_CSV),
            "forensic_json": work_label(FORENSIC_JSON),
            "forensic_csv": work_label(FORENSIC_CSV),
        },
