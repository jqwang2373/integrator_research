...
def main() -> int:
    ...
    checks.check(
        ...
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_local_row_plan.json",
        "row plan JSON path changed",
    )
    checks.check(
        row_plan_artifacts.get("csv")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_local_row_plan.csv",
        "row plan CSV path changed",
    )
    checks.check(
        row_plan_artifacts.get("markdown")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_local_row_plan.md",
        "row plan markdown path changed",
    )
    checks.check(
        row_plan_artifacts.get("validator")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/validate_closed_loop_true_dynamic_local_row_plan.py",
    ...
    checks.check(
        ...
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_interface_audit.json",
        "interface audit JSON path changed",
    )
    checks.check(
        interface_artifacts.get("csv")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_interface_audit.csv",
        "interface audit CSV path changed",
    )
    checks.check(
        interface_artifacts.get("markdown")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_interface_audit.md",
        "interface audit markdown path changed",
    )
    checks.check(
        interface_artifacts.get("validator")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/validate_closed_loop_true_dynamic_interface_audit.py",
    ...
    checks.check(
        ...
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_residual_scaffold.json",
        "residual scaffold JSON path changed",
    )
    checks.check(
        scaffold_artifacts.get("csv")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_residual_scaffold.csv",
        "residual scaffold CSV path changed",
    )
    checks.check(
        scaffold_artifacts.get("markdown")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_residual_scaffold.md",
        "residual scaffold markdown path changed",
    )
    checks.check(
        scaffold_artifacts.get("validator")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/validate_closed_loop_true_dynamic_residual_scaffold.py",
    ...
    checks.check(
        ...
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_stage_residual_audit.json",
        "stage residual audit JSON path changed",
    )
    checks.check(
        stage_audit_artifacts.get("csv")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_stage_residual_audit.csv",
        "stage residual audit CSV path changed",
    )
    checks.check(
        stage_audit_artifacts.get("markdown")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_stage_residual_audit.md",
        "stage residual audit markdown path changed",
    )
    checks.check(
        stage_audit_artifacts.get("validator")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/validate_closed_loop_true_dynamic_stage_residual_audit.py",
    ...
    checks.check(
        ...
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_one_step_smoke.json",
        "one-step smoke JSON path changed",
    )
    checks.check(
        one_step_artifacts.get("csv")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_one_step_smoke.csv",
        "one-step smoke CSV path changed",
    )
    checks.check(
        one_step_artifacts.get("markdown")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_one_step_smoke.md",
        "one-step smoke markdown path changed",
    )
    checks.check(
        one_step_artifacts.get("validator")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/validate_closed_loop_true_dynamic_one_step_smoke.py",
    ...
    checks.check(
        ...
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_newton_stage_smoke.json",
        "Newton stage smoke JSON path changed",
    )
    checks.check(
        newton_stage_artifacts.get("csv")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_newton_stage_smoke.csv",
        "Newton stage smoke CSV path changed",
    )
    checks.check(
        newton_stage_artifacts.get("markdown")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_newton_stage_smoke.md",
        "Newton stage smoke markdown path changed",
    )
    checks.check(
        newton_stage_artifacts.get("validator")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/validate_closed_loop_true_dynamic_newton_stage_smoke.py",
    ...
    checks.check(
        ...
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_newton_coarse_order_rows.csv",
        "Newton coarse-order CSV path changed",
    )
    checks.check(
        newton_coarse_artifacts.get("markdown")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_newton_coarse_order.md",
        "Newton coarse-order markdown path changed",
    )
    checks.check(
        newton_coarse_artifacts.get("validator")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/validate_closed_loop_true_dynamic_newton_coarse_order.py",
    ...
    checks.check(
        ...
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_public_work_precision.json",
        "public work/precision JSON path changed",
    )
    checks.check(
        public_work_artifacts.get("csv")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_public_work_precision_rows.csv",
        "public work/precision CSV path changed",
    )
    checks.check(
        public_work_artifacts.get("summary_csv")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_public_work_precision_summary.csv",
        "public work/precision summary CSV path changed",
    )
    checks.check(
        public_work_artifacts.get("markdown")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_public_work_precision.md",
        "public work/precision markdown path changed",
    )
    checks.check(
        public_work_artifacts.get("validator")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/validate_closed_loop_true_dynamic_public_work_precision.py",
    ...
    checks.check(
        ...
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_strict_common_reference_rows.csv",
        "strict common-reference CSV path changed",
    )
    checks.check(
        strict_common_artifacts.get("summary_csv")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_strict_common_reference_summary.csv",
        "strict common-reference summary CSV path changed",
    )
    checks.check(
        strict_common_artifacts.get("markdown")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_strict_common_reference.md",
        "strict common-reference markdown path changed",
    )
    checks.check(
        strict_common_artifacts.get("figure")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_strict_common_reference_work_precision.png",
        "strict common-reference figure path changed",
    )
    checks.check(
        strict_common_artifacts.get("validator")
        == "../../numerics/v048_cross_paper_same_test_benchmarks/validate_closed_loop_true_dynamic_strict_common_reference.py",
