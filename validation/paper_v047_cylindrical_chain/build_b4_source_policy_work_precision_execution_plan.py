...
def summarize_executed_ra2021_shard(form: str) -> dict[str, Any]:
    shard_label = (
        "../../numerics/v048_cross_paper_same_test_benchmarks/results/ra2021_double_order_shards/"
...
def build_gauss6_local_source_policy_evidence() -> dict[str, Any]:
    single = summarize_gauss6_csv(
        "../../numerics/v048_cross_paper_same_test_benchmarks/results/gauss6_fullva_public_horizon_single_rows.csv"
    )
...
def build_ra2021_double_local_source_policy_candidate_evidence() -> dict[str, Any]:
    ...
    validator_label = "../../numerics/v048_cross_paper_same_test_benchmarks/validate_ra2021_double_local_source_policy_candidate.py"
    summary_path = manuscript_path(summary_label)
    rows_path = manuscript_path(rows_label)
...
def build_hi2022_full_t8_source_policy_candidate_evidence(
    ...
    validator_label = "../../numerics/v048_cross_paper_same_test_benchmarks/validate_hi2022_full_t8_source_policy_candidate.py"
    validator_path = manuscript_path(validator_label)
...
def script_item(path_label: str) -> dict[str, Any]:
    ...
    return {
        "path": f"../../numerics/v048_cross_paper_same_test_benchmarks/{path_label}",
        "exists": path.exists() and path.stat().st_size > 0,
    ...
    launch_commands = [
        {
            ...
            "expected_output_after_run": "../../numerics/v048_cross_paper_same_test_benchmarks/results/ra2021_public_timing_rows.csv",
        ...
        },
        {
            ...
            "expected_output_after_run": "../../numerics/v048_cross_paper_same_test_benchmarks/results/gauss6_fullva_public_horizon_single_rows.csv",
        ...
        },
        {
            ...
            "expected_output_after_run": "../../numerics/v048_cross_paper_same_test_benchmarks/results/ra2021_double_pendulum_order_rows.csv",
        ...
        },
        {
            ...
            "expected_output_after_run": "../../numerics/v048_cross_paper_same_test_benchmarks/results/public_closed_loop_shards/four_link_1em02_1em03_1em04.csv",
        ...
        },
        {
            ...
            "expected_output_after_run": "../../numerics/v048_cross_paper_same_test_benchmarks/results/public_closed_loop_shards/slider_crank_1em02_1em03_1em04.csv",
