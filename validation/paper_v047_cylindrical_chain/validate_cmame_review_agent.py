...
def main() -> int:
    ...
    try:
        ...
        global_policy = read_json(
            PAPER / "../../numerics/v048_cross_paper_same_test_benchmarks/results/global_comparison_policy_audit.json"
        )
    ...
    v048_code_inventory = python_inventory(PAPER.parent.parent / "numerics" / "v048_cross_paper_same_test_benchmarks")
