...
from paper_paths import LATEX, LEGACY, PROOF, package_path as manuscript_path
ROOT = PAPER.parent
PIPELINE = ROOT.parent / "numerics" / "v047_cylindrical_chain_pipeline"
PYTHON = ROOT.parent / ".venv_sbel" / "bin" / "python"
...
def check_required_files() -> bool:
    required_files = [
        ...
        LEGACY / "main.pdf",
        LEGACY / "main.log",
        LEGACY / "main_concise.tex",
        LEGACY / "main_concise.pdf",
        LEGACY / "main_concise.log",
...
def main() -> int:
    ...
    failures = 0
    if args.latex:
        ok, _ = run_step("latex paper build", latex_command("main.tex"), LEGACY)
        failures += 0 if ok else 1
        ok, _ = run_step("latex concise paper build", latex_command("main_concise.tex"), LEGACY)
        failures += 0 if ok else 1
