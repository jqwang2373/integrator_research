...
def main() -> int:
    ...
    for runner in [
        "../../numerics/v048_cross_paper_same_test_benchmarks/run_v048.py",
    ...
    checks.check(
        hi_runner_files.get(
            "../../numerics/v048_cross_paper_same_test_benchmarks/run_hi2022_full_t8_source_policy_candidate.py",
            {},
        ).get("exists")
        is True,
