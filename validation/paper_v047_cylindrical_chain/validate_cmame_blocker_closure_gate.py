...
TFE_SAME_TEST_WORK_PRECISION_VALIDATOR = ROOT.parent / "numerics" / "v048_cross_paper_same_test_benchmarks" / "validate_tfe_source_pendulum_same_test_work_precision.py"
    ...
    for blocker in blockers:
        ...
        if blocker_id == "B4":
            ...
            checks.check(
                ...
                == "../../numerics/v048_cross_paper_same_test_benchmarks/results/tfe_source_pendulum_same_test_work_precision.md",
            ...
            for evidence, message in [
                ...
                (
                    "../../numerics/v048_cross_paper_same_test_benchmarks/results/tfe_source_pendulum_same_test_work_precision.png",
                    "B4 TFE same-test work/precision figure evidence missing",
                ),
                (
                    "../../numerics/v048_cross_paper_same_test_benchmarks/validate_tfe_source_pendulum_same_test_work_precision.py",
