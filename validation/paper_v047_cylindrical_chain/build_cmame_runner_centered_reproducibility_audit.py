...
RUNNER_SOURCE_CANDIDATES = [
    ("../../numerics/v048_cross_paper_same_test_benchmarks/run_coarse_four_example_order.py", "four_example_matrix_driver"),
    ("../../numerics/v048_cross_paper_same_test_benchmarks/run_v048.py", "shared_external_and_local_runner_library"),
    ("../../numerics/v048_cross_paper_same_test_benchmarks/closed_loop_fullva_dynamic_residual.py", "closed_loop_dynamic_core"),
    (
        "../../numerics/v048_cross_paper_same_test_benchmarks/build_closed_loop_true_dynamic_strict_common_reference.py",
        "four_link_slider_crank_true_dynamic_builder",
    ),
    ("../../numerics/v048_cross_paper_same_test_benchmarks/tfe_source_pendulum_model.py", "tfe_source_policy_candidate"),
]
...
def main() -> None:
    ...
    audit = {
        ...
        "generated_from": [
            ...
            "../../numerics/v048_cross_paper_same_test_benchmarks/results/global_comparison_policy_audit.json",
        ],
        "read_only": True,
