...
PROOF_CONDITIONAL_BOUNDARY_TOKENS = [
    # 2026-09-17: repinned to the compacted exact-stage-identity proof route.
    "Conditional sixth-order theorem",
    "conditional sixth-order estimate",
    "exactly three-stage Gauss collocation",
    ...
    "compact reduced-state proof tube",
    "fixed before any numerical evidence is read",
    "theorem-level solver policy",
    "fixed absolute Newton tolerance is a finite-run engineering choice",
    "finite-run diagnostics of this policy, not as its proof",
    "not inferred from finite rank probes, residual tables, or observed convergence slopes",
    "Branch selection",
    "Gauss endpoint defect",
    "Peano-kernel argument",
    "right-inverse Newton iteration",
    "retained P2 hypothesis",
    "does not discharge the hypothesis",
    "converged fixed-tolerance run outside the",
    "first-exit bootstrap",
    "Gronwall factor",
    "same-initial-state",
    "prefix-grid estimate",
    "undefined for theorem purposes",
    ...
    "order is exactly six",
    "consistency diagnostics of the accepted branch, not proof inputs",
    "inherited from the reduced Gauss collocation",
