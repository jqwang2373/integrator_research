...
def main() -> None:
    ...
    result = {
        ...
        "source_files": {
            ...
            "raw_rows": "../../numerics/v048_cross_paper_same_test_benchmarks/results/common_reference_error_raw_rows.csv",
            "common_reference_runner": "../../numerics/v048_cross_paper_same_test_benchmarks/build_common_reference_error_audit.py",
            "coarse_runner": "../../numerics/v048_cross_paper_same_test_benchmarks/run_coarse_four_example_order.py",
