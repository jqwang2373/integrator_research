...
size (left), against wall time (middle) and against total Newton iterations (right). Three stages
(order six) are the method of this paper.}
{fig:e2}
...
\begin{tabular}{P{0.06\linewidth}P{0.09\linewidth}P{0.09\linewidth}P{0.30\linewidth}P{0.12\linewidth}P{0.12\linewidth}}
\toprule
$v_s$ & pos.\ order & vel.\ order & pairwise position orders & recovery $h$ & $h_0$ (L) \\
\midrule
0.5  & 6.25 & 6.11 & 6.95, 4.58, 7.64, 5.98, 5.99 & 0.1     & $7.6\times10^{-4}$ \\
0.2  & 4.84 & 4.74 & 2.11, 4.54, 2.74, 8.57, 5.85 & 0.0125  & $1.4\times10^{-4}$ \\
0.1  & 4.74 & 4.78 & 0.47, 5.71, 4.14, 5.88, 6.72 & 0.05    & $6.7\times10^{-5}$ \\
0.05 & 3.66 & 3.66 & 0.17, 4.11, 4.47, 3.46, 5.27 & --      & $2.1\times10^{-5}$ \\
0.02 & 2.47 & 2.48 & $-0.22$, 2.29, 2.90, 1.55, 6.20 & 0.00625 & $7.1\times10^{-6}$ \\
\bottomrule
\end{tabular}
\end{table}
...
variant (left), endpoint constraint norms of both variants (middle; the velocity-level closure is
applied only when the raw defect exceeds $10^{-13}$, hence the saw-tooth), Newton iterations per
step (right).}
{fig:e6}
