"""Small SO(3) integrator library for the v001 benchmark.
...
def step_cf4(R: Array, t: float, h: float, omega_fun: OmegaFun) -> Array:
    ...
    # Right action: later algebra increments multiply on the right.
    return compose_right(compose_right(R, h * (a * w1 + b * w2)), h * (b * w1 + a * w2))
