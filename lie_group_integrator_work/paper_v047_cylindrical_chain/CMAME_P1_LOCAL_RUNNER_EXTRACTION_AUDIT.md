...
| velocity order | `6.009704989719966` |
...
|---|---|---|---:|---|
| `lie_group_integrator_work/v048_cross_paper_same_test_benchmarks/run_v048.py` | `import_v047_single_fullva_module` | dynamic_v047_import_boundary | `12` | `-` |
| `lie_group_integrator_work/v048_cross_paper_same_test_benchmarks/run_v048.py` | `public_single_reference_alignment` | single_public_reference_alignment | `10` | `np.abs, np.max, v047_module.asme_single_state_from_time` |
| `lie_group_integrator_work/v048_cross_paper_same_test_benchmarks/run_v048.py` | `run_gauss6_fullva_public_horizon_single_rows` | single_local_row_wrapper | `147` | `np.isclose, time.perf_counter, v047_module.integrate_asme_single_driven_absolute_fullva` |
| `lie_group_integrator_work/v048_cross_paper_same_test_benchmarks/run_v048.py` | `run_gauss6_fullva_public_horizon_double_coarse_rows` | double_local_row_wrapper | `149` | `np.isclose, np.isfinite, time.perf_counter, v047_module.compare_nested_trajectory, v047_module.integrate_v029_asme_double_trajectory, v047_module.load_v029, v047_module.make_asme_double_pendulum_params` |
| `lie_group_integrator_work/v048_cross_paper_same_test_benchmarks/run_coarse_four_example_order.py` | `run_local_single_double_rows` | coarse_four_example_local_entry | `58` | `rv.Gauss6PublicDoubleCoarseConfig, rv.Gauss6PublicSingleConfig, rv.run_gauss6_fullva_public_horizon_double_coarse_rows, rv.run_gauss6_fullva_public_horizon_single_rows` |
