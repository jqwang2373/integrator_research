...
- Reference no-estimate-transfer table present: `True`.
...
- Reference forbidden-transfer/replacement columns present: `True/True`.
- Reference imported-estimate locks present: `True/True/True`.
...
- D5 sidecar proof-gap legacy keys direct-route scoped: `11/11`; primitive/P6/P7/source-policy nonclosure retained: `True/True/True/True`.
...
- Stage Taylor expansion token present: `True`.
...
- Quadratic remainder token present: `True`.
- Newton--Kantorovich absorption present: `True`.
- Contraction radius present: `True`.
- Quantitative stage-error bound present: `True`.
- Stage single-instance locks present: `True/True`.
- Inexact Newton mean-value proof present: `True`.
...
- Discrete Gronwall global step present: `True`.
...
- Reader-facing proof-claim boundary present in manuscript/PDF text: `True`.
- P7 output nonclaim/residual-to-error boundary present in manuscript: `True`.
- B1 closure-scope boundary present in manuscript/PDF text: `True`.
- P6 solver-scope boundary present in manuscript/PDF text: `True`.
- P1/P2 compact-tube boundary present in manuscript/PDF text: `True`.
- P3/P4 implementation-defect boundary present in manuscript/PDF text: `True`.
- P5 direct-route boundary present in manuscript/PDF text: `True`.
...
- Auxiliary-evidence scope present in manuscript/PDF text: `True`.
...
- Direct-route dynamic/full rows: `36/132`.
...
- Rows/terms: `36/162`.
- Conditional rows/terms: `36/162`.
- Actual terms proved: `0`.
...
- Manifest status: `closed_by_direct_residual_bridge_kantorovich_route_primitive_taylor_conditional_schema_open`.
- Required PC2 route: `direct_residual_bridge_kantorovich_route`.
...
- Current B3 direct-route status: `closed`.
