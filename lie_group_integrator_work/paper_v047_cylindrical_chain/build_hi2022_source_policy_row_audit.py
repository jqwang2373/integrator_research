...
def summarize_t8_coarse_rows(shard_dir: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "artifact_dir": "../v048_cross_paper_same_test_benchmarks/results/hi2022_T8_coarse_model_shards",
...
def summarize_t8_selected_candidate() -> dict[str, Any]:
    ...
    return {
        ...
        "summary_path": f"../v048_cross_paper_same_test_benchmarks/results/{stem}_summary.json",
        "rows_path": f"../v048_cross_paper_same_test_benchmarks/results/{stem}_rows.csv",
...
def summarize_t8_selected_candidate_matrix_preflight(queue_batch: dict[str, Any]) -> dict[str, Any]:
    ...
    script_label = "../v048_cross_paper_same_test_benchmarks/run_hi2022_full_t8_source_policy_candidate.py"
    script_path = ROOT / "v048_cross_paper_same_test_benchmarks" / "run_hi2022_full_t8_source_policy_candidate.py"
            ...
            expected_shards.append(
                {
                    ...
                    "model": model,
                    "summary_path": (
                        f"../v048_cross_paper_same_test_benchmarks/results/{stem}_summary.json"
                    ),
                    "rows_path": f"../v048_cross_paper_same_test_benchmarks/results/{stem}_rows.csv",
...
def main() -> None:
    ...
    output = {
        ...
        "source_files": {
            ...
            "summary_v048": "../v048_cross_paper_same_test_benchmarks/results/summary_v048.json",
            "hi2022_halfimplicit_rows": "../v048_cross_paper_same_test_benchmarks/results/hi2022_halfimplicit_rows.csv",
            "hi2022_T8_coarse_model_shards": "../v048_cross_paper_same_test_benchmarks/results/hi2022_T8_coarse_model_shards",
            ...
            "hi2022_workload_estimate": "../v048_cross_paper_same_test_benchmarks/results/hi2022_workload_estimate.csv",
        },
    }
