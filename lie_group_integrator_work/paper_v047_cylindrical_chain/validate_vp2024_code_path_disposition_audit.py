...
def main() -> int:
    ...
    checks.check(
        source_files.get("v048_summary") == "../v048_cross_paper_same_test_benchmarks/results/summary_v048.json",
    ...
    checks.check(
        search.get("source_csv") == "../v048_cross_paper_same_test_benchmarks/results/velocity_partitioning_code_search.csv",
    ...
    for token in [
        ...
        "Search evidence source: `../v048_cross_paper_same_test_benchmarks/results/velocity_partitioning_code_search.csv`",
