...
def main() -> int:
    ...
    checks.check(
        guarded.get("execution_working_directory") == "../v048_cross_paper_same_test_benchmarks",
    ...
    for item in all_commands:
        ...
        checks.check(
            preflight.get("execution_working_directory") == "../v048_cross_paper_same_test_benchmarks",
