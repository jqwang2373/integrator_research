...
Status: `verified_authorized_driver_execution_recorded_no_source_policy_rows_promoted`.
...
- Verified authorized execution recorded: `True`.
- Existing ready-command artifacts present: `True`.
- Execution record scope: `verified_authorized_guarded_driver_execution`.
- Source-policy execution allowed now/invoked/exact opt-in required: `False/True/True`.
...
- Ready commands verified executed by this record: `13`.
...
|---|---:|---:|---|
| `four_link` | `3` | `3` | `../v048_cross_paper_same_test_benchmarks/results/public_closed_loop_shards/four_link_1em02_1em03_1em04.csv` |
| `slider_crank` | `3` | `3` | `../v048_cross_paper_same_test_benchmarks/results/public_closed_loop_shards/slider_crank_1em02_1em03_1em04.csv` |
