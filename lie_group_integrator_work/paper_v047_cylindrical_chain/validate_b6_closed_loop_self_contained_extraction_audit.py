...
def main() -> int:
    ...
    try:
        ...
        coarse = read_json(
            PAPER / "../v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_newton_coarse_order.json"
        )
        strict_common = read_json(
            PAPER / "../v048_cross_paper_same_test_benchmarks/results/closed_loop_true_dynamic_strict_common_reference.json"
        )
    ...
    expected_paths = {
        "../v048_cross_paper_same_test_benchmarks/build_closed_loop_true_dynamic_newton_coarse_order.py",
