...
- The package now has three LaTeX entry points: `main_cmame.tex` is the
  CMAME/Elsevier `elsarticle` manuscript, `main.tex` is the full
  artifact-backed status/audit paper, and `main_concise.tex` is the shorter
  supporting order-comparison draft that builds `main_concise.pdf`. All stay
  inside the same claim boundary.
...
| Check only the four ASME method rows | `cd v047_cylindrical_chain_pipeline && ../.venv_sbel/bin/python validate_four_asme_minimal.py` | No |
| Check the cross-paper same-test scaffold smoke | `cd v048_cross_paper_same_test_benchmarks && ../.venv_sbel/bin/python validate_v048_outputs.py` | No |
| Check the v048 four-example performance matrix | `cd v048_cross_paper_same_test_benchmarks && ../.venv_sbel/bin/python validate_four_example_performance_matrix.py` | No |
| Check the v048 single-pendulum coarse same-window rows | `cd v048_cross_paper_same_test_benchmarks && ../.venv_sbel/bin/python validate_single_pendulum_coarse_same_window.py` | No |
| Check the v048 closed-loop surrogate dynamic gate | `cd v048_cross_paper_same_test_benchmarks && ../.venv_sbel/bin/python validate_closed_loop_surrogate_dynamic_gate.py` | No |
| Check the v048 closed-loop dynamic error floor audit | `cd v048_cross_paper_same_test_benchmarks && ../.venv_sbel/bin/python validate_closed_loop_dynamic_error_floor_audit.py` | No |
| Check the v048 closed-loop coarse dynamic-order probe | `cd v048_cross_paper_same_test_benchmarks && ../.venv_sbel/bin/python validate_closed_loop_coarse_dynamic_order_probe.py` | No |
| Check the v048 closed-loop dynamic-order closure contract | `cd v048_cross_paper_same_test_benchmarks && ../.venv_sbel/bin/python validate_closed_loop_dynamic_order_closure_contract.py` | No |
| Check the v048 closed-loop true dynamic-row feasibility audit | `cd v048_cross_paper_same_test_benchmarks && ../.venv_sbel/bin/python validate_closed_loop_true_dynamic_row_feasibility_audit.py` | No |
| Check the v048 closed-loop true dynamic local row plan | `cd v048_cross_paper_same_test_benchmarks && ../.venv_sbel/bin/python validate_closed_loop_true_dynamic_local_row_plan.py` | No |
| Check the v048 closed-loop true dynamic interface audit | `cd v048_cross_paper_same_test_benchmarks && ../.venv_sbel/bin/python validate_closed_loop_true_dynamic_interface_audit.py` | No |
| Check the v048 closed-loop true dynamic residual scaffold | `cd v048_cross_paper_same_test_benchmarks && ../.venv_sbel/bin/python validate_closed_loop_true_dynamic_residual_scaffold.py` | No |
| Check the v048 closed-loop true dynamic stage residual audit | `cd v048_cross_paper_same_test_benchmarks && ../.venv_sbel/bin/python validate_closed_loop_true_dynamic_stage_residual_audit.py` | No |
| Check the v048 closed-loop true dynamic one-step smoke | `cd v048_cross_paper_same_test_benchmarks && ../.venv_sbel/bin/python validate_closed_loop_true_dynamic_one_step_smoke.py` | No |
| Check the v048 closed-loop true dynamic Newton stage smoke | `cd v048_cross_paper_same_test_benchmarks && ../.venv_sbel/bin/python validate_closed_loop_true_dynamic_newton_stage_smoke.py` | No |
| Check the v048 closed-loop true dynamic Newton coarse order | `cd v048_cross_paper_same_test_benchmarks && ../.venv_sbel/bin/python validate_closed_loop_true_dynamic_newton_coarse_order.py` | No |
| Check the v048 closed-loop true dynamic public work/precision rows | `cd v048_cross_paper_same_test_benchmarks && ../.venv_sbel/bin/python validate_closed_loop_true_dynamic_public_work_precision.py` | No |
| Check the v048 closed-loop strict common-reference work/precision rows | `cd v048_cross_paper_same_test_benchmarks && ../.venv_sbel/bin/python validate_closed_loop_true_dynamic_strict_common_reference.py` | No |
| Check the v048 residual-to-error theorem obligations | `cd v048_cross_paper_same_test_benchmarks && ../.venv_sbel/bin/python validate_closed_loop_residual_to_error_theorem_obligations.py` | No |
| Check the v048 coarse-first external readiness gate | `cd v048_cross_paper_same_test_benchmarks && ../.venv_sbel/bin/python validate_coarse_first_external_readiness_gate.py` | No |
| Run only the v048 public-code dependency smoke | `cd v048_cross_paper_same_test_benchmarks && ../.venv_sbel/bin/python run_v048.py` | No |
| Check the whole repository artifact inventory | `.venv_sbel/bin/python validate_pipeline_outputs.py` | No |
| Rebuild only the PDF from existing figures and tables | `cd paper_v047_cylindrical_chain && cmd.exe /c latexmk -pdf -interaction=nonstopmode main.tex` | No |
| Rebuild only the CMAME/Elsevier manuscript | `cd paper_v047_cylindrical_chain && cmd.exe /c latexmk -pdf -interaction=nonstopmode main_cmame.tex` | No |
...
| Rebuild only the concise better-integrator paper | `cd paper_v047_cylindrical_chain && cmd.exe /c latexmk -pdf -interaction=nonstopmode main_concise.tex` | No |
...
| Regenerate every v047 numerical artifact | `cd v047_cylindrical_chain_pipeline && ../.venv_sbel/bin/python run_v047.py` | Yes |
