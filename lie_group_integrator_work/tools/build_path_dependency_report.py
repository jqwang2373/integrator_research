...
LATEX = WORK / "paper"  # manuscript assets since 2026-09-20; reported with the prefix "../paper/"
...
MANUSCRIPTS = {"../paper/main_cmame.tex": "CMAME manuscript source (authoritative)",
               ...
               "../paper/main.tex": "legacy internal status report (superseded, kept for the record)",
               "../paper/main_concise.tex": "legacy concise draft (superseded, kept for the record)"}
...
def family_of(rel: str) -> str:
    ...
    if rel.startswith("lean/"):
        return "lean"
    if rel.startswith("notes/") or rel.startswith("../paper/notes/"):
        return "note"
...
def main() -> int:
    ...
    pairs = collect(PAPER, "") + collect(LATEX, "../paper/")
    ...
    payload = {
        ...
        "manuscript_dir": "lie_group_integrator_work/paper (reported with the prefix ../paper/)",
